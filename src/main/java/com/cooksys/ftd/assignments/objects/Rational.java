...
//			System.out.print(denominator +"=?"+ that.denominator);
//			System.out.println(denominator == that.denominator);
//			System.out.print(numerator +"=?"+ that.numerator);
//			System.out.println(numerator == that.numerator);
